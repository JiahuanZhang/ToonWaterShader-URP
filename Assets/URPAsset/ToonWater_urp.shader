Shader "Roystan/Toon_URP/Water Tut"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (v2f i) : SV_Target
            {
				...
				float existingDepth01 = SAMPLE_TEXTURE2D(_CameraDepthTexture, sampler_CameraDepthTexture, uv).r;
				...
				float3 existingNormal =  tex2D(_CameraNormalsTexture, uv);
